...
def calculate_correlations(filter_by_relevant_lang=True):
    ...
    for lang in languages:
        ...
        annotation_file = os.path.join(annotation_dir, f"culture_annotation_datasets_annotated_human_{lang}.csv")
        ...
        lang_annotations['avg_score'] = lang_annotations[['annotator_1', 'annotator_2', 'annotator_3']].mean(axis=1)
    ...
    for lang in languages:
        ...
        for feature in feature_cols:
            ...
            # Pearson correlation
            if 'pearson' in all_results[lang] and feature in all_results[lang]['pearson']:
            ...
            if 'spearman' in all_results[lang] and feature in all_results[lang]['spearman']:
    ...
    if all_results:
        ...
        filter_text = "Filtered by relevant language" if filter_by_relevant_lang else "All annotations"
        plt.title(f"Spearman Correlation between Features and Basicness Scores ({filter_text})", fontsize=14)
        plt.tight_layout()
